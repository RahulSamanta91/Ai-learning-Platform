...
const QuizResultPage = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      {/* Score Card */}
      <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-8 mb-5">
        <div className="text-center space-y-6">
          ...
          <div className="flex items-center justify-center gap-4 pt-4">
            ...
            <div className="flex items-center gap-2 px-4 py-2 bg-slate-50 border border-slate-200 rounded-xl">
              <XCircle className="w-4 h-4 text-slate-600" strokeWidth={2} />
              <span className="text-sm font-semibold text-slate-700">
              ...
              {result.explanation && (
                <div className="p-4 bg-linear-to-br from-slate-50 to-slate-100/50 border border-slate-200 rounded-xl">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <p
                        className="text-xs font-semibold text-slate-600 uppercase tracking-wide mb-1
                      "
                      >
                        Explanation
                      </p>
