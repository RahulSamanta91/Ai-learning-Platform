      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col items-center space-y-8">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="px-3 py-1.5 sm:px-4 sm:py-2 bg-slate-50 rounded-lg border border-slate-200 whitespace-nowrap">
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <button
            onClick={handleGenerateFlashcards}
            disabled={generating}
            className="group inline-flex items-center justify-center gap-2 px-5 h-11 w-full sm:w-auto bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100 cursor-pointer"
          >
            {generating ? (
              <>
      ...
      >
        <div className="space-y-6">
          <p className="text-sm text-slate-600">
            ...
            can't be undone and all cards will be permanently removed.
          </p>
