  ...
  return (
    <>
      ...
      >
        ...
        {/* Logo ans Close button for mobile */}
        ...
        <div className="px-3 py-4 border-t border-slate-200/60 ">
          <button
            ...
            className="group flex items-center gap-3 w-full px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-red-500 hover:text-white rounded-xl transition-all duration-200 cursor-pointer"
          >
            <LogOut
              size={18}
              strokeWidth={2.5}
