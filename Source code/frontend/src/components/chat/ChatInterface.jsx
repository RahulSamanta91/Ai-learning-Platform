  ...
  const renderMessage = (msg, index) => {
    ...
    return (
      ...
      >
        ...
        {isUser && (
          <div className="w-9 h-9 rounded-xl bg-linear-to-br from-slate-300 flex items-center justify-center text-slate-700 font-semibold text-sm shrink-0 shadow-sm">
      ...
      <div className="p-5 border-t border-slate-200/60 bg-white/80">
        <form onSubmit={handleSendMessage} className="flex items-center gap-3">
          ...
          <button
            ...
            className="shrink-0 w-12 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 text-white rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95 flex items-center justify-center cursor-pointer"
          >
